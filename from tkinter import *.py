...
def replace_terms():
    ...
    #These lists are temporary and will be switched to a dictionary or eventually a database to accomodate multiple term suggestions depending on final tool format.
